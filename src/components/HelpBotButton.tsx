...
export const HelpBotButton: React.FC<HelpBotButtonProps> = ({ onClick }) => {
  ...
  return (
    <button
      ...
      className="group relative flex items-center justify-center w-14 h-14 bg-[var(--llyc-turquoise)] text-[var(--llyc-white)] rounded-full shadow-lg hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[var(--llyc-white)] focus:ring-[var(--llyc-turquoise)] transition-all duration-150 ease-in-out"
    >
      <HelpIcon />
       <span
