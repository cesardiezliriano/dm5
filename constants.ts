...
export const AD_SPECS_DATA: AdFormatSpec[] = [
  ...
  // YouTube Ads / Google Ads Video
  {
    ...
    aspectRatio: "16:9 (horizontal), 1:1 (square), 4:5 (vertical), 9:16 (vertical full-screen)",
    fileTypes: ["MP4 preferred"],
  ...
  },
  {
    ...
    aspectRatio: "16:9 (horizontal), 1:1 (square), 4:5 (vertical), 9:16 (vertical)",
    fileTypes: ["MP4"],
    maxFileSize: "200MB (max)",
    bestPracticesKeys: [
  ...
  // IAB Formats
  {
    ...
    generationType: "video_script",
    aspectRatio: "16:9 (preferred), 4:3, 21:9", // As per IAB New Ad Portfolio
  ...
  },
  {
    ...
    aspectRatio: "1:1 recommended", // Also 16:9
    fileTypes: ["MP4", "MOV"],
    maxFileSize: "1GB (recommended <30MB)",
    bestPracticesKeys: [
