  ...
  return (
    <div>
      ...
      <select
        ...
        className="w-full p-3 font-open-sans bg-[var(--llyc-input-bg)] border border-[var(--llyc-gray-3)] rounded-md shadow-sm focus:ring-2 focus:ring-[var(--llyc-red)] focus:border-[var(--llyc-red)] text-[var(--llyc-white)] placeholder-[var(--llyc-gray-2)] disabled:opacity-50 disabled:cursor-not-allowed"
      >
